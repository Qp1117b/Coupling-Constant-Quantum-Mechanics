...
| CQM 层级 | 结构群 | 基本 $V$ | $GL(n)$ | 态数 |
|:---|:---|:---|:---|:---:|
| GL(1) | $U(1)$ | $\mathbb{C}$ | $GL(1)$ | 1 |
| GL(2) | $SU(2)$ | $\mathbb{C}^2$ | $GL(2)$ | 2 |
| GL(3) | $SU(3)$ | $\mathbb{C}^3$ | $GL(3)$ | 3 |
| GL(4) | $SU(4)$ | $\mathbb{C}^4$ | $GL(4)$ | 4 |
| GL(5) | $SU(5)$ | $\mathbb{C}^5$ | $GL(5)$ | 5 |
