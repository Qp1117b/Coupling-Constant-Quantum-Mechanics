...
- **RQM 唯物化文档化**：将关系量子力学的唯物化操作正式纳入 SPAF 框架文档（§0）。三条原则：属性随附本体、因果自组织、观测者相对性的自然消解。推论：电子去特权化——取消电子的本体特权，使嘉当矩阵拼接理论得以统一处理超导问题，与 BCS 历史实践（晶格是关键）一致
...
- **Tr(A₄⁻¹) 勘误**：`cartanInvTrace_eq_four` 证明 Tr(A⁻¹)=4；07 嘉当结构文档 §4.2 的 2 与直接计算不符，修正后 1/Tr(A⁻¹)=1/4 恰为谱间隙 E₀=1/4 的自洽输入
